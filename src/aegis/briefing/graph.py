...
def build_briefing_graph() -> StateGraph:
    ...
    graph.add_node("fetch_leetcode", fetch_leetcode)
    graph.add_node("fetch_jobs", fetch_jobs)
    graph.add_node("fetch_leetcode_progress", fetch_leetcode_progress)
